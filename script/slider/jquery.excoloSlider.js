    ...
    Plugin.prototype = {
        ...
        **********************************************************/
        defaults: {
            ...
            pagerNav: true,
            startSlide: 1,
            //startSlide: Math.floor(Math.random() * 4) + 1,
            autoPlay: false,
            delay: 0,
            interval: 5000,
            repeat: true,
        ...
        **********************************************************/
        init: function () {
            ...
            if (base.config.prevnextNav)
            {
                ...
                $wrapper.after("<div class='" + base.config.nextButtonClass + "'><i class='fa fa-x fa-chevron-right'></i>");
                $wrapper.after("<div class='" + base.config.prevButtonClass + "'><i class='fa fa-x fa-chevron-left '></i>");
        ...
        **********************************************************/
        _slide: function (postalign) {
			...
			//----------------FIX----------@@to callfunction after each slide ends
			//color()
