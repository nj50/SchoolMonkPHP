...
(function() {
	var BuilderView, EditFieldView, Formbuilder, FormbuilderCollection, FormbuilderModel, ViewFieldView, _ref, _ref1, _ref2, _ref3, _ref4, QuestionView,ref0,
...
//alert(this.model.get(Formbuilder.options.mappings.REQUIRED));
		//alert('s'+this.model.get(Formbuilder.options.mappings.QA_class));
			if(this.model.get(Formbuilder.options.mappings.QA_class)){this.$el.addClass('nonEdit');}
...
//---------------------------------------------------------------------------
	...
	BuilderView = (function(_super) { 
		...
		BuilderView.prototype.events = {
			...
			'click .qa-add-field-types a': 'qaaddField',
	...
	//-------Wking QA
	BuilderView.prototype.qaaddField = function(e) {
      var field_type;
      field_type = 'text';
      return this.createQAField(Formbuilder.helpers.defaultFieldAttrs(field_type));
    };
	BuilderView.prototype.createQAField = function(attrs, options) {
      var rf;
      rf = this.collection.create(attrs, options);
      this.createAndShowView(rf);
      return this.handleFormUpdate();
    };
	BuilderView.prototype.createAndShowView = function(model) {
		var $newEditEl, $responseFieldEl;
		$responseFieldEl = this.$el.find(".fb-field-wrapper").filter(function() {
			return $(this).data('cid') === model.cid;
		});
		$responseFieldEl.addClass('nonEdit').siblings('.fb-field-wrapper').removeClass('editing');
    ...
    BuilderView.prototype.createAndShowEditView = function(model) {
		...
		if($responseFieldEl.hasClass('nonEdit')){}else{
			$responseFieldEl.addClass('editing').siblings('.fb-field-wrapper').removeClass('editing');
			if (this.editView) {//for existing edit
  ...
  Formbuilder = (function() {
    Formbuilder.helpers = {
      defaultFieldAttrs: function(field_type) {
        ...
        attrs[Formbuilder.options.mappings.QA_class] = '';
...
(function() {
  Formbuilder.registerField('price', {
    ...
    view: "<div class='input-line'>\n  <span class='above-line'>&#8377;</span>\n  <span class=''>\n    <input type='text' />\n    <label>Rupee</label>\n  </span>\n </div>",
    edit: "",
    addButton: "<span class=\"symbol\"><span class=\"fa fa-inr\"></span></span> Price"
  });
...
(function() {
  Formbuilder.registerField('custom', {
    order: 305,
    view: "<input type='text' placeholder='' />",
    edit: "",
    addButton: "<span class=\"symbol\"><span class=\"fa fa-link\"></span></span> Custom QA"
  });
}).call(this);
...
this["Formbuilder"]["templates"]["partials/quetions"] = function(obj) {
obj || (obj = {});
var  __p = '';
//function print() { __p += __j.call(arguments, '') }
with (obj) {
__p += '<div class=\'fb-tab-pane\' id=\'quetions\'>\n  <div class=\'qa-add-field-types\'>\n    <div class=\'section\'>\n  <a class="ui-draggable">QA 1</a>  </div>\n  </div>\n</div>\n';
